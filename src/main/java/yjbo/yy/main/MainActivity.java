...
//        getSupportActionBar().hide();
    ...
    private void setOnclick() {
        ...
        findViewById(R.id.diafr_complexe_full_sc)
                .setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        ComplexDialogFrag complexDialogFrag = new ComplexDialogFrag(Gravity.TOP,true, true, false){

                            @Override
                            protected View bindLayout(LayoutInflater inflater, ViewGroup container) {
                                View view = inflater.inflate(R.layout.fragment_dialog_text, container);
                                ViewHolderUtil viewHolderUtil = new ViewHolderUtil(view);
                                viewHolderUtil.setOnClickListener(R.id.neu, new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                        Toast.makeText(MainActivity.this, "点击了全屏的中立", Toast.LENGTH_SHORT).show();
                                        hideDialog();
                                    }
                                });
                                viewHolderUtil.setOnClickListener(R.id.neg, new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                        Toast.makeText(MainActivity.this, "点击了全屏的确认", Toast.LENGTH_SHORT).show();
                                        hideDialog();
